...
.card{background:var(--panel);border:1px solid var(--line);border-radius:16px;
  padding:18px;margin-bottom:12px;min-height:330px;box-shadow:0 8px 24px rgba(0,0,0,.12)}
        ...
        out.append(
            {
                ...
                "VWAP": "ABOVE" if c.get("above_vwap") else "BELOW",
                "Liquidity $M": round(
