...
def prefer_best_live_feed(sa, symbol="SPY"):
    ...
    Tradier is already consolidated and is the primary live provider when
    configured, so probing Alpaca SIP in that case only adds latency and an
