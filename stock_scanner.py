...
HEADERS = {
    ...
    "User-Agent": "github-stock-scanner/2.2",
}
...
def critical_fail_count(c):
    """Count failures that most directly affect whether a momentum trade is executable."""
    count = 0
...
def main():
    ...
    print(f"Momentum scan v2.2 started: {now_et:%Y-%m-%d %H:%M:%S %Z}")
    print(
        "Mode: "
