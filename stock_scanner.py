...
HEADERS = {
    ...
    "User-Agent": "github-stock-scanner/2.4",
}
...
def print_watchlist(rows):
    ...
    print(
        ...
        f"{'SRC':>7}{'IEXSPR%':>10}{'FROMHI%':>10}{'VWAP':>7}  FAILED FILTERS / WARNINGS"
    )
    print("-" * 160)
...
def main():
    ...
    print(f"Momentum scan v2.4 started: {now_et:%Y-%m-%d %H:%M:%S %Z}")
    print(
        "Mode: "
